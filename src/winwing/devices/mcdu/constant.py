...
class COLORS(Enum):
    BLACK = Color(name="black", key="l", ww_mask=0x0000, term="\033[38;5;0m", rgb=(32, 32, 32))  # L, Should be brown, o, spotted
    AMBER = Color(name="amber", key="a", ww_mask=0x0021, term="\033[38;5;208m", rgb=(255, 179, 0))  # spotted
    WHITE = Color(name="white", key="w", ww_mask=0x0042, term="\033[38;5;231m", rgb=(255, 255, 255))  # not spotted
    CYAN = Color(name="cyan", key="b", ww_mask=0x0063, term="\033[38;5;39m", rgb=(0, 196, 255))  # spotted
    GREEN = Color(name="green", key="g", ww_mask=0x0084, term="\033[38;5;46m", rgb=(0, 255, 61))  # spotted
    MAGENTA = Color(name="magenta", key="m", ww_mask=0x00A5, term="\033[38;5;165m", rgb=(255, 64, 255))
    RED = Color(name="red", key="r", ww_mask=0x00C6, term="\033[38;5;196m", rgb=(255, 0, 0))  # spotted
    YELLOW = Color(name="yellow", key="y", ww_mask=0x00E7, term="\033[38;5;226m", rgb=(255, 255, 0))  # spotted
    KAKI = Color(name="kaki", key="x", ww_mask=0x0108, term="\033[38;5;221m", rgb=(97, 92, 66))  # X, k, spotted
    GREY = Color(name="grey", key="e", ww_mask=0x0129, term="\033[38;5;251m", rgb=(119, 119, 119))  # E, spotted
    DEFAULT = Color(name="white", key="w", ww_mask=0x0042, term="\033[38;5;231m", rgb=(255, 255, 255))  # spotted
